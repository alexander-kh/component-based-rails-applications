    ...
    describe "GET edit" do
      ...
      describe "view" do
        ...
        it "renders the edit team form" do
          ...
          assert_select "form[action=?][method=?]", teams_team_path(team),
            "post" do
              assert_select "input#teams_team_name"
          end
        end
    ...
    describe "POST create" do
      context "with valid params" do
        it "creates a new Teams::Team" do
          ...
          post :create, params: {teams_team: valid_attributes},
      ...
      context "with invalid params" do
        it "assigns a newly created but unsaved team as @team" do
          post :create, params: {teams_team: invalid_attributes},
                        session: valid_session
          expect(assigns(:team)).to be_a_new Teams::Team
        end
    ...
    describe "PUT update" do
      context "with valid params" do
        ...
        it "updates the requested team" do
          ...
          put :update, params: {id: existing_team.to_param,
                                teams_team: new_attributes},
                       session: valid_session
        ...
        it "assigns the requested team as @team" do
          team = create_team
          put :update, params: {id: team.to_param,
                                teams_team: valid_attributes},
                       session: valid_session
          expect(assigns(:team)).to eq(team)
        end
