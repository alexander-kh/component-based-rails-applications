  ...
  RSpec.describe GamesController, type: :controller do
    ...
    describe "GET show" do
      ...
      it "routes to #show" do
        expect(get: "/games/1").
          to route_to("games_admin/games#show", id: "1")
      end
    end
    ...
    describe "GET edit" do
      ...
      it "routes to #edit" do
        expect(get: "/games/1/edit").
          to route_to("games_admin/games#edit", id: "1")
      end
    end
    ...
    describe "PUT update" do
      context "with valid params" do
        ...
        it "routes to #update" do
          expect(put: "/games/1").
            to route_to("games_admin/games#update", id: "1")
        end
      end
    ...
    describe "DELETE destroy" do
      ...
      it "routes to #destroy" do
        expect(delete: "/games/1").
          to route_to("games_admin/games#destroy", id: "1")
      end
    end
  end
end
