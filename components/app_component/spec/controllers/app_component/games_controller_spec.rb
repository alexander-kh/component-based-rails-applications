module AppComponent
  RSpec.describe GamesController, type: :controller do
    ...
    let(:valid_attributes) {
      new_game(first_team_id: @team1.id, second_team_id: @team2.id).as_json }

    let(:invalid_attributes) {
      new_game(first_team_id: @team1.id, second_team_id: @team2.id).
      tap { |g| g.location = nil }.as_json}
    let(:valid_session) { {} }
    ...
    describe "GET show" do
      ...
      it "routes to #show" do
        expect(get: "/games/1").
          to route_to("app_component/games#show", id: "1")
      end
    end
    ...
    describe "GET edit" do
      ...
      it "routes to #edit" do
        expect(get: "/games/1/edit").
          to route_to("app_component/games#edit", id: "1")
      end
    end
    ...
    describe "PUT update" do
      context "with valid params" do
        it "updates the requested game" do
          game = create_game
          new_time = 1.day.ago
          put :update, params: {id: game.to_param, game: {date: new_time}},
                       session: valid_session
          game.reload
        ...
        it "routes to #update" do
          expect(put: "/games/1").
            to route_to("app_component/games#update", id: "1")
        end
      end
    ...
    describe "DELETE destroy" do
      ...
      it "routes to #destroy" do
        expect(delete: "/games/1").
          to route_to("app_component/games#destroy", id: "1")
      end
    end
  end
end
